...
st.markdown("""
    ...
    /* Forzar fondo negro en header y app */
    ...
    .floating-btn-container { position: fixed; top: 10px; right: 20px; z-index: 9999; }
    ...
    .stTable th, .stTable td { color: #ffffff !important; padding: 10px 15px !important; border-bottom: 1px solid #31333f !important; }
    .stTable thead tr { background-color: #262730 !important; }
    </style>
""", unsafe_allow_html=True)

# --- BOTÓN PARA CONTROLAR BARRA LATERAL ---
st.markdown("""
