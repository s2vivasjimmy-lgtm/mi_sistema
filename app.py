...
# 2. INTERFAZ NORMAL
    ...
    if st.session_state.admin_logueado:
        ...
        # Mapa y botón pantalla completa
        if st.button("🌐 ABRIR MAPA EN PANTALLA COMPLETA"):
            st.session_state.mostrar_mapa = True
            st.rerun()
            
        st.components.v1.html('<iframe src="https://www.google.com/maps/d/embed?mid=1mOUOQ2t-N_BrEWYqqySXGBW5MQuZQIg" width="100%" height="400" frameborder="0" style="border:0;"></iframe>', height=410)
