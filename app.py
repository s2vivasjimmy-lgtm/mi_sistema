...
# --- FUNCIÓN DE MAPA CON ENGAÑO CSS PARA IPHONE ---
def renderizar_mapa_ios(id_mapa, url):
    st.components.v1.html(f"""
    <div id="wrapper-{id_mapa}" style="position: relative; width: 100%; height: 500px; overflow: hidden; background: #0E1117;">
        <iframe id="iframe-{id_mapa}" src="{url}" style="width: 100%; height: 100%; border: none; position: absolute; top: 0; left: 0;" allow="fullscreen"></iframe>
        <button onclick="expandir('{id_mapa}')" style="position: absolute; top: 10px; right: 10px; z-index: 2147483647; padding: 10px; background: #FFD700; border: none; border-radius: 5px; font-weight: bold; cursor: pointer;">⛶</button>
    </div>
    <script>
