...
with st.sidebar:
    ...
    seleccion = st.radio("Seleccionar categoría:", 
                         ["Resumen General", "Hospitales de Campaña", 
                          "Campamentos Transitorios", "Sistema de Salud Tradicional", "Inmunización", 
...
if seleccion == "Resumen General":
    ...
    archivo_detalle = "inmunización.csv"
    if os.path.exists(archivo_detalle):
        ...
        st.download_button("📥 Descargar Reporte", data=convertir_df_a_excel(df_detalle), file_name=f"{seleccion}.xlsx")
